...
<div class="container mt-4">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <form method="GET" action="{{ route('requisitions.index_7th') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-12 text-center mt-3">
                    {{-- Filter form --}}
                    <form action="{{ route('requisitions.index_7th') }}" method="GET" class="d-inline">
                    ...
                    {{-- Export PDF form --}}
                    <form action="{{ route('vacancy.exportPdf7th') }}" method="GET" class="d-inline">
